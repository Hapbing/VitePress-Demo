...
export const NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://docs.icegl.cn/logo.png',
        title: 'TvT.js',
        desc: '🎉 三维可视化项目快速落地の开源框架 🎉',
        link: 'https://docs.icegl.cn/',
      },
      {
        icon: 'https://docs.tresjs.org/favicon.svg',
        title: 'TresJS',
        desc: '将 Three 带到了 Vue 生态系统中',
        link: 'https://docs.tresjs.org/zh/',
      },
      {
        icon: 'https://threehub.cn/files/site/logo.svg',
        title: '开源三维',
        desc: '一个优秀的前端三维开源案例网站',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://www.esbuild.cn/favicon.svg',
        title: 'esbuild',
        desc: 'An extremely fast bundler for the web',
        link: 'https://www.esbuild.cn/getting-started/',
      },
      {
